...
func (m *machineTUIModel) onboardingView() string {
	...
	lines := []string{
		...
		"",
		machinePrimary.Render("Work on camps that live on your other computers."),
		machinePrimary.Render("Add one here and you can reach it from this terminal:"),
		"",
		machineCommand("camp switch devbox:my-camp", "open a camp over there"),
		machineCommand("camp list --remote", "camps on every machine at once"),
		"",
