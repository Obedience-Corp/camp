...
var manifestAgentAllowedReasons = map[string]string{
	...
	"root":                       "Read-only camp root output",
	...
	"switch":                     "Non-interactive with explicit camp argument",
	...
	"workitem convert":           "Non-interactive type-root convert fully specified by selector and --type",
	...
	"workitem completion":        "Explicit reversible lifecycle decision with selector, action, and structured output",
