...
var (
	...
	ErrNotInCampaign = errors.New("not inside a camp directory\n" +
	...
	ErrCampaignExists = camperrors.Newf("camp already exists in this directory: %w", camperrors.ErrAlreadyExists)

	// ErrInvalidCampaign is returned when the campaign directory is corrupted or invalid.
	ErrInvalidCampaign = camperrors.Newf("invalid camp directory: %w", camperrors.ErrInvalidInput)
)
