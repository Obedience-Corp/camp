...
func TestClassifyCommit(t *testing.T) {
	tests := []struct {
		...
		{"degraded phase without festival", "[obey-campaign:8deed8b4-PH-001] feat: scaffold", ClassDegraded},
		{"degraded phase and sequence without festival", "[obey-campaign:8deed8b4-PH-001-SQ-02] feat: scaffold", ClassDegraded},
		{"degraded sequence with neither parent", "[obey-campaign:8deed8b4-SQ-02] feat: scaffold", ClassDegraded},
