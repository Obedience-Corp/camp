...
func TestGenerateWithDescriptions_NoArgs(t *testing.T) {
	...
	shortcuts := map[string]bool{"p": true, "pw": true, "f": true, "d": true, "du": true, "w": true, "r": true, "de": true, "i": true}
	foundShortcuts := 0
	...
	if foundShortcuts != 9 {
		t.Errorf("Found %d shortcuts, want 9", foundShortcuts)
	}
}
