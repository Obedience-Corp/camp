...
type CommitMessageHookConfig struct {
	...
	// ("12m", "90s"). Empty takes autowrite.DefaultWriterTimeout.
	//
...
// ShortcutSource constants identify the origin of a shortcut entry.
const (
	// ShortcutSourceAuto marks shortcuts generated by camp init.
	ShortcutSourceAuto = "auto"
	// ShortcutSourceUser marks shortcuts added manually by the user.
	ShortcutSourceUser = "user"
)
...
type ShortcutConfig struct {
	...
	// Source indicates who created this shortcut: "auto" for camp-generated,
	// "user" for manually added. Empty is treated as "user" (safe default for legacy).
