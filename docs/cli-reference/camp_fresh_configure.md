...
* [camp fresh configure edit](camp_fresh_configure_edit.md)	 - Edit a follow-up command workflow step
...
* [camp fresh configure set](camp_fresh_configure_set.md)	 - Set a camp fresh workflow setting
