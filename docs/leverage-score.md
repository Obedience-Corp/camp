...
Camp project discovery excludes its `projects/worktrees` storage directory.
Leverage also rejects saved entries for worktree storage and removes them from
the leverage config.
